...
9. **중복 금지**: CTA 씬의 headline은 업체명 "{business.name}"과 반드시 달라야 합니다. "지금 예약하세요", "방문해 보세요" 등 행동 유도 문구를 사용하세요.
10. **씬간 중복 금지**: 각 씬의 headline과 subtext는 서로 겹치지 않아야 합니다. 같은 표현을 다른 씬에서 반복하지 마세요.
